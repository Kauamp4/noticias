...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const noticias = document.querySelectorAll(".games-noticia");
    ...
    function realizarBusca() {
        ...
        noticias.forEach((noticia) => {
            ...
            const descricao = noticia
                .querySelector("p")
                ?.textContent
                .toLowerCase() || "";

            const categoria = noticia
                .querySelector(".games-noticia-tag")
                ?.textContent
                .toLowerCase() || "";
            ...
            noticia.style.display = encontrou ? "" : "none";
